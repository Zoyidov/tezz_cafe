...
//   Future<Either<Failure, List<OrderModel>>> getOrders(String cafeId,String waitressId);
// }
//
...
//
//   @override
//   Future<Either<Failure, List<OrderModel>>> getOrders(String cafeId,String waitressId) async {
//     try {
//       final orders = await orderDataSource.getOrders(cafeId,waitressId);
//       return Right(orders);
